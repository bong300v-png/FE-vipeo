...
export function LogoIcon({ className }: IconProps) {
  return (
    <span className={cn("inline-flex items-center gap-2 text-xl font-black tracking-tight text-foreground", className)}>
      <svg viewBox="0 0 36 36" className="size-8 shrink-0" aria-hidden="true">
        ...
        <path
          d="M8 12v-1.5A2.5 2.5 0 0 1 10.5 8H12M24 8h1.5A2.5 2.5 0 0 1 28 10.5V12M28 24v1.5a2.5 2.5 0 0 1-2.5 2.5H24M12 28h-1.5A2.5 2.5 0 0 1 8 25.5V24"
          className="stroke-primary-foreground/60"
          strokeWidth="2"
          strokeLinecap="round"
          fill="none"
        />
        {/* V that doubles as a play wedge */}
        <path
          d="M12.2 12.5h3.4l2.4 6.9 2.4-6.9h3.4L18.9 24.4a1 1 0 0 1-1.8 0L12.2 12.5Z"
          className="fill-primary-foreground"
        />
        {/* Record dot */}
        <circle cx="25.4" cy="17.2" r="1.8" className="fill-primary-foreground/70" />
      </svg>
      <span>Vipeo</span>
    </span>
  );
...
export function ChevronsUpDownIcon({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
